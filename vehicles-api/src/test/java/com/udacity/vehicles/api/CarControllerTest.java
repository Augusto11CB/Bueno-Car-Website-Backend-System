...
public class CarControllerTest {
    ...
    public void listCars() throws Exception {
        /**
         * HERE: Add a test to check that the `get` method works by calling
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$._embedded.carList[0].id")
                        .value(car.getId()))
                .andExpect(jsonPath("$._embedded.carList[0].price")
                        .value(car.getPrice()))
    ...
    public void deleteCar() throws Exception {
        /**
         * HERE: Add a test to check whether a vehicle is appropriately deleted
